...
class MyoRaw(object):
    ...
    def connect(self):
        ...
        def handle_data(p):
            ...
            if attr == 0x27:
               ...
               #else:
                #   print("THIS IS SO DUMB. PYTHON IS FOR LOSERS.")
            else:
    ...
    #Below is code used to create vibrations. May not be needed
    ...
    def sleep_mode(self, mode):
        self.write_attr(0x19, pack('3B', 9, 1, mode)) #mode = 0 normal mode = 1 never sleep
 
    def power_off(self):
        self.write_attr(0x19, b'\x04\x00') #Technically deep sleep. Requires USB for power on.
...
if __name__ == '__main__':
    ...
    def proc_emg(emg, moving, times=[]):
        if HAVE_PYGAME:
            ...
            ## Uncomment below to enable emg data display numerically
            #print(emg)
        else:
            print(emg)
